<template>
  <div class="image-animation">
    <div class="flyinTxtCont">
      <br>
      <div class="flyIn ligne1">La musique</div>
      <div class="flyIn ligne2">est la langue </div>
      <div class="flyIn ligne3">des émotions</div>
    </div>
  </div>
</template>
...
.image-animation {
  height: 100%;
  background-image: url(https://tweakers.fr/wp-content/uploads/2020/04/comment-choisir.jpg);
  background-size: 125%;
